...
public class Splashscreen2State extends GameState {

	private String title = "PRESENTS";

	private String title2 = "- JIMMY'S ADVENTURE";

	private Font titleFont = new Font("Georgia", Font.BOLD, 54);
	...
	public Splashscreen2State(GameStateManager gsm) {
